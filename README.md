...
> 2) проверить что __объектное__ чтение документа и его непустой табличной части для 8.3.6 и младше выполняется в транзакции
...
домашнее задание:
> привести пример для каждой из блокировок. *Подсказка:track locks in MSSMS->Management->Extended Events*
--------------------------------------------------
