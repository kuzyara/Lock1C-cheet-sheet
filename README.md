...
#### 3. Платформа НЕ устанавливает _управляемых_ блокировок при чтении в объектной технике как минимум следующих объектов:
...
> 2) ответить на вопрос - проверить что __объектное__ чтение документа и его табличной части для 8.3.6 и младше выполняется в транзакции
