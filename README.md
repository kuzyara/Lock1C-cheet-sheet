...
todo: ответить на поврос - устанавливает ли платформа траззакционные блокировки СУБД при чтении данных запросом?
...
В общем случае, разумеется, получение динамических списков пр ииспользовании обычных форм выполняется вне транзакции.
...
![alt text](https://github.com/kuzyara/Lock1C-cheet-sheet/blob/master/images/lock-object-screen.png)
...
* оптимистические - `ДокументСсылка.ПолучитьОбъект()`
...
--------------------------------------------------
 Какие бывают Управляемые блокировки:
* Транзакционные:
    * исключительные - `ЭлементБлокировки.Режим = РежимБлокировкиДанных.Разделяемый;`
        * явные
        * неявные
    * разделяемые - `ЭлементБлокировки.Режим = РежимБлокировкиДанных.Исключительный;`
        * явные
        * неявные
--------------------------------------------------
 Какие бывают Транзакционные блокировки:
