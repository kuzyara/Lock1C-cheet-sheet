...
*Задача: наложение правильных блокировок в рег. задании автоматического создания расх. ордеров по реализациям в процедуре МодульЛогистики.СформироватьРасходник*
