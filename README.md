...
Получение прикладного объекта через `ПолучитьОбъект()` всегда происходит с использованием объектной блокировки. _Пояснение: здесь имеется ввиду оптимистическая объектная блокировка, подробнее см. [Какие бывают блокировки](#какие-бывают-блокировки)_
